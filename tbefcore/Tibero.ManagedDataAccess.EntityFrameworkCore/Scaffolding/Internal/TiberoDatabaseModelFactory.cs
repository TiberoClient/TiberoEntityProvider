...
{
    public class TiberoDatabaseModelFactory : IDatabaseModelFactory
    {
        ...
        /// </summary>
        public TiberoDatabaseModelFactory([NotNull] IDiagnosticsLogger<DbLoggerCategory.Scaffolding> logger)
        {
        ...
        public virtual DatabaseModel Create(string connectionString, IEnumerable<string> tables, IEnumerable<string> schemas)
        {
            ...
            using (var connection = new TiberoConnection(connectionString))
            {
