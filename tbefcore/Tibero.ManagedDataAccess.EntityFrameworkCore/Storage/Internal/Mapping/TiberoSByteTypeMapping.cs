...
{
    class TiberoSByteTypeMapping : SByteTypeMapping
    {
        public TiberoSByteTypeMapping(
          [NotNull] string storeType,
          [CanBeNull] DbType? dbType
          )
          : this(new RelationalTypeMappingParameters(
                    new CoreTypeMappingParameters(typeof(sbyte), new TiberoSByteConverter()),
                    storeType,
        ...
        protected TiberoSByteTypeMapping(
      ...
      : base(parameters)
        ...
        {
            return new TiberoSByteTypeMapping(this.Parameters.WithStoreTypeAndSize(storeType, size, new StoreTypePostfix?()));
        }

        public override CoreTypeMapping Clone(ValueConverter converter)
        {
            return new TiberoSByteTypeMapping(Parameters.WithComposedConverter(converter));
        }
        ...
        protected override void ConfigureParameter(DbParameter parameter)
        {
            ...
            ((TiberoParameter)parameter).TiberoDbType = TiberoDbType.Int16;
        }
    }
}