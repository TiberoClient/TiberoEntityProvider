...
{
    public class TiberoDateTimeOffsetLocalTypeMapping : DateTimeOffsetTypeMapping
    {
        ...
        /*
          ...
          */
        public TiberoDateTimeOffsetLocalTypeMapping(
            [NotNull] string storeType,
            DbType? dbType = System.Data.DbType.DateTimeOffset)
            : this(new RelationalTypeMappingParameters(
                    new CoreTypeMappingParameters(typeof(DateTimeOffset), new TiberoDateTimeOffsetLocalConverter()),
                    storeType,
        ...
        protected TiberoDateTimeOffsetLocalTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        ...
        public override RelationalTypeMapping Clone(string storeType, int? size)
            => new TiberoDateTimeOffsetLocalTypeMapping(Parameters.WithStoreTypeAndSize(storeType, size));


        public override CoreTypeMapping Clone(ValueConverter converter)
            => new TiberoDateTimeOffsetLocalTypeMapping(Parameters.WithComposedConverter(converter));
    ...
    bool? nullable = null)
        ...
        protected override void ConfigureParameter(DbParameter parameter)
        {
            ...
            ((TiberoParameter)parameter).TiberoDbType = TiberoDbType.TimeStampLTZ;
        }
